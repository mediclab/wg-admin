...
return [
    ...
    */
    ...
    'auth' => [
        ...
        'pages' => [
            'login' => \App\Http\Components\Auth\Login::class,
        ],
    ],
    ...
    */
    ...
    'widgets' => [
        ...
        'register' => [
            \App\Http\Widgets\StatsOverview::class,
            \App\Http\Widgets\DevicesTable::class,
        ],
    ],
    ...
    */
    ...
    'default_avatar_provider' => \App\Providers\AvatarProviders\GravatarProvider::class,
